...
+1)++"G.\^[[B\^[["++show(ऒ*1+1)++"Gv\^[[5E");अ(fmap(\औ→if औ`elem`ऌ!!0||औ`elem`ऌ
!!1 then '#' else ' ')[0..79]++"\n");if ऒ`elem`ऌ!!5||ऒ`elem`ऌ!!6 then ओ ऊ else उ
(ऊ+1,13*ऋ`आ`(2^31-1),take 7(ऑ:ऌ),ऒ)};ओ ऊ=अ"Score: ">>print ऊ>>exitSuccess}
-- ^10 ------------------------------------------------------------------ 80> --
