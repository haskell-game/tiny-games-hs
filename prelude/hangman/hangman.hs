...
|j=' ';h n|e n>[]=do{g 0('.'<$e n)(e n);q<-b"롹蔪℮䪻蕜"['y','n'];case q of 'y'->\
...
"꣱趿戃"|'.'#a->do{q<-b"덽ᤃӝ᥆ᤆ"ϕ;g(n+1-(fromEnum$q#v))(z(f q)v a)v}|j->r"꣱轐䫠"}
e n=[y|y<-w,notElem y$e<$>[0..n-1]]!!(read[y|y<-__TIME__,y<':']`mod`length w-n)
w=words.d$"扩Ბᨿӆ蕀ᚇ✤貺˱杙䉦帀ᨸ䳿䍍䳤貉䜕泂跤䚘賧䛲乽͊㴍ϗ爋ٶᩈː躴䝃Ⅎᩁː躝滋䝃⌹ƙ剾ᤃ㌹㜶贌ⱋ跤䢣ᓲŮ淚懲ⳇ仡";ϕ=['a'..'z']
-- ^10 ------------------------------------------------------------------ 80> --
{- prelude-10-80/hangman (kukimik)

Running: runghc -XCPP -XMultiWayIf -XLambdaCase hangman.hs
